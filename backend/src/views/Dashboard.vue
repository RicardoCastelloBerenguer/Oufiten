<template>
    ...
    <div class="grid grid-cols-1 grid-flow-col grid-rows-2 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white flex items-center flex-col justify-center py-6 px-4 rounded-lg shadow-lg">
        ...
        <div class="bg-white py-6 px-5 rounded-lg shadow-lg">
            <template v-if="!loading.ordersByCountry">
