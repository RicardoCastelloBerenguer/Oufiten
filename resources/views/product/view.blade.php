<x-app-layout>
    ...
    <div x-data="productItem({{
        ...
        )" class="container mx-auto mt-1">
        <div class="grid gap-6 sm-grid-cols-1 grid-cols-1 lg:grid-cols-5">
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    >
                        ...
                        >
                            ...
                            {{$product->show_catalogue==0 ? 'El producto está retirado del catálogo' : 'Añadir al carrito'}}
                    </button>
